...
joined.plot = joined %>%
  select(subjectID, run, volume, volMean, volSD, starts_with("euclidian"), trashDiff, trashOut, trash, auto, outcount) %>%
  gather(compare, code, -c(subjectID, run, volume, volMean, volSD, trashDiff, trashOut, trash, starts_with("euclidian")))
